...
public class StudentEnquiryManager {
    ...
    public void submitEnquiry(Student student) {
        ...
        //if(Check if camp is open to that student before allowing him/her to submit enquiry, add a method in this class that checks that)
            ...
            enquirylist.addEnquiry(student.getUserID(), campName, enquiryContent);
    ...
    public void deleteEnquiry(Student student, EnquiryList enquiryList) {
    ...
    public void editEnquiry(Student student, EnquiryList enquiryList) {
    	//make this check if that particular student has made any enquiries and not just check whether the whole enquirylist is full or empty
    	if (enquiryList.isEmpty()) {
    ...
    public void viewEnquiries(Student student, EnquiryList enquiryList) {
    	//make this check if that particular student has made any enquiries and not just check whether the whole enquirylist is full or empty
    	if (enquiryList.isEmpty()) {
