...
public class CCMSuggestionManager {
    ...
    // Submit a suggestion
    public void submitSuggestion(String studentUserID, Camp camp) {
        ...
        // Check if it's the right camp name
        if (!campName.equals(camp.getCampName())) {
            System.out.println("You are not authorised to submit a suggestion for this camp");
        }
        ...
        if (suggestionList.isEmpty()) {
            ...
            for (Suggestion suggestion : suggestionList.getSuggestionList()) {
                if (suggestion.getSuggestionID() == suggestionID && studentUserID.equals(suggestion.getStudentUserID())) {
                    ...
                    if (!objectFinder.findSuggestionById(suggestionID, suggestionList).getStudentUserID().equals(studentUserID)) {
